...
"""
MQTT_HOST = "3.94.171.136"  # "ip.maquina.mqtt"
MQTT_PORT = 8082
...
"""
BASE_TOPIC = (
    "colombia/cundinamarca/bogota/" + MQTT_USER
)  # "<país>/<estado>/<ciudad>/" + MQTT_USER
...
def process_message(msg: str):
    ...
    # Lógica para el nuevo evento del Reto
    ...
    # Mantener compatibilidad con alertas normales
    elif "ALERT" in msg:
        print("ALERTA DE RANGO DETECTADA: " + msg)
...
def measure_data():
    ...
    mqtt_publish(
        MQTT_PUB_TOPIC, json.dumps({"temperatura": temperature, "humedad": moisture})
    )
